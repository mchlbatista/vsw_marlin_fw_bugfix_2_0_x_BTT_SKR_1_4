...
#define STRING_CONFIG_H_AUTHOR "(MB, Voron_SW BTT_SKR_1_4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Voron Switchwire"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 25, 0 } // PINDA V2 On Afterburner
...
#define X_MIN_POS 0  // Set Afterburner nozzle position!!
#define Y_MIN_POS 0  // Set Afterburner nozzle position!!
#define Z_MIN_POS 0
